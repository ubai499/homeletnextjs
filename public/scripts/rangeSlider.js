...
! function(t) {
    ...
    t.cleanData = function(e) {
        ...
        for (var s, n, o = i.call(arguments, 1), a = 0, u = o.length; a < u; a++)
        ...
        t.fn[e] = function(o) {
            ...
            return a ? this.length || "instance" !== o ? this.each(function() {
                ...
                return "instance" === o ? (r = s, !1) : s ? t.isFunction(s[o]) && "_" !== o.charAt(0) ? (i = s[o].apply(s, u), i !== s && void 0 !== i ? (r = i && i.jquery ? r.pushStack(i.get()) : i, !1) : void 0) : t.error("no such method '" + o + "' for " + e + " widget instance") : t.error("cannot call methods on " + e + " prior to initialization; attempted to call method '" + o + "'")
            }) : r = void 0 : (u.length && (o = t.widget.extend.apply(null, [o].concat(u))), this.each(function() {
                var e = t.data(this, n);
        ...
        _classes: function(e) {
            function i(i, o) {
                var a, u;
                for (u = 0; u < i.length; u++) a = n.classesElementLookup[i[u]] || t(), a = t(e.add ? t.unique(a.get().concat(e.element.get())) : a.not(e.element).get()), n.classesElementLookup[i[u]] = a, s.push(i[u]), o && e.classes[i[u]] && s.push(e.classes[i[u]])
            }
            var s = [],
                n = this;
            return e = t.extend({
        ...
        t.Widget.prototype["_" + e] = function(s, n, o) {
            ...
            var a, u = n ? !0 === n || "number" == typeof n ? i : n.effect || i : e;
            "number" == typeof(n = n || {}) && (n = {
                duration: n
            }), a = !t.isEmptyObject(n), n.complete = o, n.delay && s.delay(n.delay), a && t.effects && t.effects.effect[u] ? s[e](n) : u !== e && s[u] ? s[u](n.duration, n.easing, o) : s.queue(function(i) {
                t(this)[e](), o && o.call(s[0]), i()
            })
        }
    });
