              ...
              <div className={cliked ? "utf-more-search-options-area" : "utf-more-search-options-area active"}>
                <div className="utf-more-search-options-area-container">
                  ...
                  >
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue1} style={{display:'none'}} onClick={()=>setChkValue9(chkValue9 => !chkValue9)}/>
                        {/* <input id="house" class="radio-button" type="checkbox" name="office" /> */}
                        <div className={chkValue9 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon house-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue9} style={{display:'none'}} onClick={()=>setChkValue9(chkValue9 => !chkValue9)}/>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue10} style={{display:'none'}} onClick={()=>setChkValue10(chkValue10 => !chkValue10)}/>
                      {/* <input id="flat" class="radio-button" type="checkbox" name="warehouse" /> */}
                        <div className={chkValue10 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon flat-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue11} style={{display:'none'}} onClick={()=>setChkValue11(chkValue11 => !chkValue11)}/>
                      {/* <input id="hostel" class="radio-button" type="checkbox" name="factory" /> */}
                        <div className={chkValue11 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon hostel-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue12} style={{display:'none'}} onClick={()=>setChkValue12(chkValue12 => !chkValue12)}/>
                      {/* <input id="lowerportion" class="radio-button" type="checkbox" name="building" /> */}
                        <div className={chkValue12 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon lowerportion-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue13} style={{display:'none'}} onClick={()=>setChkValue13(chkValue13 => !chkValue13)}/>
                      {/* <input id="room" class="radio-button" type="checkbox" name="gym" /> */}
                        <div className={chkValue13 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon room-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue14} style={{display:'none'}} onClick={()=>setChkValue14(chkValue14 => !chkValue14)}/>
                      {/* <input id="farmhouse" class="radio-button" type="checkbox" name="theatre" /> */}
                        <div className={chkValue14 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon farmhouse-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue15} style={{display:'none'}} onClick={()=>setChkValue15(chkValue15 => !chkValue15)}/>
                      {/* <input id="penthouse" class="radio-button" type="checkbox" name="foodcourt" /> */}
                        <div className={chkValue15 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon penthouse-icon">
                  ...
                  >
                    ...
                    >
                        <input type="checkbox" value="test" checked={chkValue16} style={{display:'none'}} onClick={()=>setChkValue16(chkValue16 => !chkValue16)}/>
                        {/* <input id="house" class="radio-button" type="checkbox" name="residential" /> */}
                        <div className={chkValue16 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon house-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue17} style={{display:'none'}} onClick={()=>setChkValue17(chkValue17 => !chkValue17)}/>
                      {/* <input id="guesthouse" class="radio-button" type="checkbox" name="commercial" /> */}
                        <div className={chkValue17 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon house-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue18} style={{display:'none'}} onClick={()=>setChkValue18(chkValue18 => !chkValue18)}/>
                      {/* <input id="flat" class="radio-button" type="checkbox" name="agricultural" /> */}
                        <div className={chkValue18 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon flat-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue19} style={{display:'none'}} onClick={()=>setChkValue19(chkValue19 => !chkValue19)}/>
                      {/* <input id="hostel" class="radio-button" type="checkbox" name="industrial" /> */}
                        <div className={chkValue19 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon hostel-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue20} style={{display:'none'}} onClick={()=>setChkValue20(chkValue20 => !chkValue20)}/>
                      {/* <input id="lowerportion" class="radio-button" type="checkbox" name="plotfile" /> */}
                        <div className={chkValue20 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon lowerportion-icon">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue21} style={{display:'none'}} onClick={()=>setChkValue21(chkValue21 => !chkValue21)}/>
                      {/* <input id="room" class="radio-button" type="checkbox" name="farmhouseplot" /> */}
                        <div className={chkValue21 ? "radio-tile2" : "radio-tile"}>
                          <div class="icon room-icon">
