...
const Banner = () => {
  ...
  const [chkValue1, setChkValue1] = useState(false);
  const [chkValue2, setChkValue2] = useState(false);
  const [chkValue3, setChkValue3] = useState(false);
  const [chkValue4, setChkValue4] = useState(false);
  const [chkValue5, setChkValue5] = useState(false);
  const [chkValue6, setChkValue6] = useState(false);
  const [chkValue7, setChkValue7] = useState(false);
  const [chkValue8, setChkValue8] = useState(false);
  const [chkValue9, setChkValue9] = useState(false);
  const [chkValue10, setChkValue10] = useState(false);
  const [chkValue11, setChkValue11] = useState(false);
  const [chkValue12, setChkValue12] = useState(false);
  const [chkValue13, setChkValue13] = useState(false);
  const [chkValue14, setChkValue14] = useState(false);
  const [chkValue15, setChkValue15] = useState(false);
  const [chkValue16, setChkValue16] = useState(false);
  const [chkValue17, setChkValue17] = useState(false);
  const [chkValue18, setChkValue18] = useState(false);
  ...
  <div className="row">
    <div className="col-md-12">
      <div className="utf-main-search-container-area">
              ...
              <div className={cliked ? "utf-more-search-options-area" : "utf-more-search-options-area active"}>
                <div className="utf-more-search-options-area-container">
                  ...
                  >
                    ...
                    >
                        <input type="checkbox" value="test" checked={chkValue} style={{display:'none'}}/>
                        {/* <input id="house" class="radio-button" type="checkbox" name="house" value="residential" /> */}
                        <div className={chkValue ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue(chkValue => !chkValue)}>
                          <div class="icon house-icon">
                            <svg className={chkValue ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <label for="house" className={chkValue ? "radio-tile-label-checked" : "radio-tile-label"}>House</label>
                    </li>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue2} style={{display:'none'}}/>
                      {/* <input id="guesthouse" class="radio-button" type="checkbox" name="guesthouse" value="guesthouse" /> */}
                        <div className={chkValue2 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue2(chkValue2 => !chkValue2)}>
                          <div class="icon house-icon">
                            <svg className={chkValue2 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                              {/* <path d="M0 0h24v24H0z" fill="none"/> */}
                        ...
                        <label for="guesthouse" className={chkValue2 ? "radio-tile-label-checked" : "radio-tile-label"}>Guest House</label>
                    </li>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue3} style={{display:'none'}}/>
                      {/* <input id="flat" class="radio-button" type="checkbox" name="flat" value="flat"/> */}
                        <div className={chkValue3 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue3(chkValue3 => !chkValue3)}>
                          <div class="icon flat-icon">
                            <svg className={chkValue3 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                              {/* <path d="M0 0h24v24H0z" fill="none"/> */}
                        ...
                        <label for="flat" className={chkValue3 ? "radio-tile-label-checked" : "radio-tile-label"}>Flat</label>
                    </li>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue4} style={{display:'none'}}/>
                      {/* <input id="hostel" class="radio-button" type="checkbox" name="hostel" value="hostel" /> */}
                        <div className={chkValue4 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue4(chkValue4 => !chkValue4)}>
                          <div class="icon hostel-icon">
                            <svg className={chkValue4 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                              {/* <path d="M0 0h24v24H0z" fill="none"/> */}
                        ...
                        <label for="hostel" className={chkValue4 ? "radio-tile-label-checked" : "radio-tile-label"}>Hostel</label>
                    </li>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue5} style={{display:'none'}}/>
                      {/* <input id="lowerportion" class="radio-button" type="checkbox" name="lowerportion" value="lowerportion" /> */}
                        <div className={chkValue5 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue5(chkValue5 => !chkValue5)}>
                          <div class="icon lowerportion-icon">
                            <svg className={chkValue5 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                              {/* <path d="M0 0h24v24H0z" fill="none"/> */}
                        ...
                        <label for="lowerportion" className={chkValue5 ? "radio-tile-label-checked" : "radio-tile-label"}>Lower Portion</label>
                    </li>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue6} style={{display:'none'}}/>
                      {/* <input id="room" class="radio-button" type="checkbox" name="room" value="room" /> */}
                        <div className={chkValue6 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue6(chkValue6 => !chkValue6)}>
                          <div class="icon room-icon">
                            <svg className={chkValue6 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                              {/* <path d="M0 0h24v24H0z" fill="none"/> */}
                        ...
                        <label for="room" className={chkValue6 ? "radio-tile-label-checked" : "radio-tile-label"}>Room</label>
                    </li>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue7} style={{display:'none'}}/>
                      {/* <input id="farmhouse" class="radio-button" type="checkbox" name="farmhouse" value="farmhouse" /> */}
                        <div className={chkValue7 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue7(chkValue7 => !chkValue7)}>
                          <div class="icon farmhouse-icon">
                            <svg className={chkValue7 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                              {/* <path d="M0 0h24v24H0z" fill="none"/> */}
                        ...
                        <label for="farmhouse" className={chkValue7 ? "radio-tile-label-checked" : "radio-tile-label"}>Farm House</label>
                    </li>
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue8} style={{display:'none'}}/>
                      {/* <input id="penthouse" class="radio-button" type="checkbox" name="penthouse" value="penthouse" /> */}
                        <div className={chkValue8 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue8(chkValue8 => !chkValue8)}>
                          <div class="icon penthouse-icon">
                            <svg className={chkValue8 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                              {/* <path d="M0 0h24v24H0z" fill="none"/> */}
                            <path d="M49.6,31.69,32.71,14.8h0L32,14.09l-.35.35h0L14.4,31.69l.71.71,3.78-3.79v21.3h26V28.38l4,4ZM43.87,48.91h-24V27.61L32,15.51,43.87,27.38Z"/>
                            </svg>
                          </div>
                        </div>
                        <label for="penthouse" className={chkValue8 ? "radio-tile-label-checked" : "radio-tile-label"}>Pent House</label>
                    </li>
                  </ul>
                  </div>
                  ...
                  >
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue1} style={{display:'none'}} />
                        {/* <input id="house" class="radio-button" type="checkbox" name="office" /> */}
                        <div className={chkValue1 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue1(chkValue1 => !chkValue1)}>
                          <div class="icon house-icon">
                            <svg className={chkValue1 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue9} style={{display:'none'}}/>
                      {/* <input id="guesthouse" class="radio-button" type="checkbox" name="shop" /> */}
                        <div className={chkValue9 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue9(chkValue9 => !chkValue9)}>
                          <div class="icon house-icon">
                            <svg className={chkValue9 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue10} style={{display:'none'}}/>
                      {/* <input id="flat" class="radio-button" type="checkbox" name="warehouse" /> */}
                        <div className={chkValue10 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue10(chkValue10 => !chkValue10)}>
                          <div class="icon flat-icon">
                            <svg className={chkValue10 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue11} style={{display:'none'}}/>
                      {/* <input id="hostel" class="radio-button" type="checkbox" name="factory" /> */}
                        <div className={chkValue11 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue11(chkValue11 => !chkValue11)}>
                          <div class="icon hostel-icon">
                            <svg className={chkValue11 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue12} style={{display:'none'}}/>
                      {/* <input id="lowerportion" class="radio-button" type="checkbox" name="building" /> */}
                        <div className={chkValue12 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue12(chkValue12 => !chkValue12)}>
                          <div class="icon lowerportion-icon">
                            <svg className={chkValue12 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue13} style={{display:'none'}} />
                      {/* <input id="room" class="radio-button" type="checkbox" name="gym" /> */}
                        <div className={chkValue13 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue13(chkValue13 => !chkValue13)}>
                          <div class="icon room-icon">
                            <svg className={chkValue13 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue14} style={{display:'none'}}/>
                      {/* <input id="farmhouse" class="radio-button" type="checkbox" name="theatre" /> */}
                        <div className={chkValue14 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue14(chkValue14 => !chkValue14)}>
                          <div class="icon farmhouse-icon">
                            <svg className={chkValue14 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue15} style={{display:'none'}}/>
                      {/* <input id="penthouse" class="radio-button" type="checkbox" name="foodcourt" /> */}
                        <div className={chkValue15 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue15(chkValue15 => !chkValue15)}>
                          <div class="icon penthouse-icon">
                            <svg className={chkValue15 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                  ...
                  >
                    ...
                    >
                        <input type="checkbox" value="test" checked={chkValue16} style={{display:'none'}}/>
                        {/* <input id="house" class="radio-button" type="checkbox" name="residential" /> */}
                        <div className={chkValue16 ? "radio-tile2" : "radio-tile"}  onClick={()=>setChkValue16(chkValue16 => !chkValue16)}>
                          <div class="icon house-icon">
                            <svg className={chkValue16 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue17} style={{display:'none'}}/>
                      {/* <input id="guesthouse" class="radio-button" type="checkbox" name="commercial" /> */}
                        <div className={chkValue17 ? "radio-tile2" : "radio-tile"} onClick={()=>setChkValue17(chkValue17 => !chkValue17)}>
                          <div class="icon house-icon">
                            <svg className={chkValue17 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue18} style={{display:'none'}}/>
                      {/* <input id="flat" class="radio-button" type="checkbox" name="agricultural" /> */}
                        <div className={chkValue18 ? "radio-tile2" : "radio-tile"}  onClick={()=>setChkValue18(chkValue18 => !chkValue18)}>
                          <div class="icon flat-icon">
                            <svg className={chkValue18 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue19} style={{display:'none'}}/>
                      {/* <input id="hostel" class="radio-button" type="checkbox" name="industrial" /> */}
                        <div className={chkValue19 ? "radio-tile2" : "radio-tile"}  onClick={()=>setChkValue19(chkValue19 => !chkValue19)}>
                          <div class="icon hostel-icon">
                            <svg className={chkValue19 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue20} style={{display:'none'}}/>
                      {/* <input id="lowerportion" class="radio-button" type="checkbox" name="plotfile" /> */}
                        <div className={chkValue20 ? "radio-tile2" : "radio-tile"}  onClick={()=>setChkValue20(chkValue20 => !chkValue20)}>
                          <div class="icon lowerportion-icon">
                            <svg className={chkValue20 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
                    ...
                    >
                      <input type="checkbox" value="test" checked={chkValue21} style={{display:'none'}}/>
                      {/* <input id="room" class="radio-button" type="checkbox" name="farmhouseplot" /> */}
                        <div className={chkValue21 ? "radio-tile2" : "radio-tile"}  onClick={()=>setChkValue21(chkValue21 => !chkValue21)}>
                          <div class="icon room-icon">
                            <svg className={chkValue21 ? "svg2" : "svg"} height="64" viewBox="0 0 64 64" width="64" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* INVESTMENT FORM */}
        <form id="investmentform" className={clicks ? "utf-main-search-form-item showform" : "utf-main-search-form-item"} action="">
          <div className="utf-main-search-box-area">
            <div className="row with-forms">
