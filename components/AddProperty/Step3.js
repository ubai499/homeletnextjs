      ...
      <>
        ...
        <section className="style_property_detail_section__LE1g_">
          ...
          <ul className="style_property_subtype_action__RR7G4">
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input id="flat" type="radio" name="wantedBtn" onChange={handleChange('propertysubtype')} defaultValue={'Flat'}
                />
                <span className="style_content__FhYfn">
                  <span className="style_img_wrapper__tI0fk">
                    <span
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Hostel'}
                />
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Upper Portion'}
                />
                <span className="style_content__FhYfn">
                  <span className="style_img_wrapper__tI0fk">
                    <span
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Lower Portion'}
                />
                <span className="style_content__FhYfn">
                  <span className="style_img_wrapper__tI0fk">
                    <span
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input id="room" type="radio" name="wantedBtn" onChange={handleChange('propertysubtype')} defaultValue={'Room'}
                />
                <span className="style_content__FhYfn">
                  <span className="style_img_wrapper__tI0fk">
                    <span
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Farm House'}
                />
                <span className="style_content__FhYfn">
                  <span className="style_img_wrapper__tI0fk">
                    <span
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Pent Hosue'}
                />
                <span className="style_content__FhYfn">
                  <span className="style_img_wrapper__tI0fk">
                    <span
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Hotel suites'}
                />
                <span className="style_content__FhYfn">
                  <span className="style_img_wrapper__tI0fk">
                    <span
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Basement'}
            ...
            <li>
              <label className="style_type_btn__zofvl">
                <input
                  ...
                  type="radio"
                  name="wantedBtn"
                  onChange={handleChange('propertysubtype')} defaultValue={'Annexe'}
